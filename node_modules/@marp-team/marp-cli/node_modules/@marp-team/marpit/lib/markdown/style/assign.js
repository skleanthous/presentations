...
const injectScopePostCSSplugin = _postcss.default.plugin('marpit-style-assign-postcss-inject-scope', (key, keyframeSet) => css => css.each(function inject(node) {
  const {
    type,
    name
  } = node;
...
const scopeKeyframesPostCSSPlugin = _postcss.default.plugin('marpit-style-assign-postcss-scope-keyframes', (key, keyframeSet) => css => {
